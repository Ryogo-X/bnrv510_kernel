...
)
{
	...
	pHalmac_adapter->fw_version.h2c_version = (u16)fw_h2c_ver;
...
/**
 * halmac_free_download_firmware_88xx() - free download Firmware
 * @pHalmac_adapter
 * @pHamacl_fw : FW bin file
 * @halmac_fw_size
 * Author : KaiYuan Chang/Ivan Lin
...
/**
 * halmac_p2pps_88xx() -used to send p2pps h2c packet cmd
 * @pHalmac_adapter
 * @pP2PPS
 * Author : Alan
 * Return : HALMAC_RET_STATUS
