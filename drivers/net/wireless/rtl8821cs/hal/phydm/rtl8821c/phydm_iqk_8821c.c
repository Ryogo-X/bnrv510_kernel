...
)
{
	...
	while (1) {
		...
		case 3:		/*S0 RXIQK*/
			while (1) {
				KFAIL = _IQK_RXIQKbyPath_8821C(p_dm_odm, ODM_RF_PATH_A);
...
)
{
	...
	u32	backup_mac_reg[MAC_REG_NUM_8821C] = {0x520, 0x550};
...
/*IQK version:v0.8, NCTL v0.7*/
/*1.make sure that the RF0x1[0]=0 after iqk*/
