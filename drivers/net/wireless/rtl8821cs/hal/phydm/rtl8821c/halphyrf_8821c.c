...
)
{
	...
	odm_set_bb_reg(p_dm_odm, 0xcb4, (BIT(3) | BIT2 | BIT1 | BIT0), 0x7);	/*DPDT_SEL_N set to be 0*/
	odm_set_bb_reg(p_dm_odm, 0xcb4, (BIT(7) | BIT6 | BIT5 | BIT4), 0x7);	/*DPDT_SEL_P set to be 0*/
	odm_set_bb_reg(p_dm_odm, 0xcb4, (BIT(29) | BIT28), 0x1);		/*invert DPDT_SEL_N*/

	if (is_main)
		odm_set_bb_reg(p_dm_odm, 0xcb4, (BIT(29) | BIT28), 0x1);	/*invert DPDT_SEL_N*/
	else
		odm_set_bb_reg(p_dm_odm, 0xcb4, (BIT(29) | BIT28), 0x2);	/*invert DPDT_SEL_P*/
...
)
{
	...
	if (odm_get_bb_reg(p_dm_odm, 0xcb4, (BIT(29) | BIT28)) == 0x1)	/*WiFi */
		return true;
	else
		return false;
}
