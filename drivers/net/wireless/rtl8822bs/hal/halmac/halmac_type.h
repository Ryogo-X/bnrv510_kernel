...
typedef enum _HALMAC_HW_ID {
	...
	HALMAC_HW_WLAN_EFUSE_AVAILABLE_SIZE = 6,
	HALMAC_HW_TXFF_ALLOCATION = 7,
	HALMAC_HW_USB_MODE = 8,
	HALMAC_HW_SEQ_EN = 9,
	HALMAC_HW_BANDWIDTH = 10,
	HALMAC_HW_CHANNEL = 11,
	HALMAC_HW_PRI_CHANNEL_IDX = 12,
	HALMAC_HW_EN_BB_RF = 13,
	HALMAC_HW_BT_BANK_EFUSE_SIZE = 14,
	HALMAC_HW_BT_BANK1_EFUSE_SIZE = 15,
	HALMAC_HW_BT_BANK2_EFUSE_SIZE = 16,
	HALMAC_HW_SDIO_TX_PAGE_THRESHOLD = 17,
	HALMAC_HW_IC_VERSION = 18,
	HALMAC_HW_PAGE_SIZE = 19,
	HALMAC_HW_TX_AGG_ALIGN_SIZE = 20,
	HALMAC_HW_RX_AGG_ALIGN_SIZE = 21,
	HALMAC_HW_DRV_INFO_SIZE = 22,
