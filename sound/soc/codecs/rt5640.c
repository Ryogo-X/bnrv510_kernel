...
//#define USE_EQ
//#define USE_ASRC
#define VERSION "0.8.8 alsa 1.0.24"
...
bool rt5640_button_detect(struct snd_soc_codec *codec)
{
	bool pressed;

	if (SND_SOC_BIAS_OFF == codec->dapm.bias_level) {
		snd_soc_write(codec, RT5640_PWR_ANLG1, 0x2004);
		snd_soc_write(codec, RT5640_MICBIAS, 0x3830 | RT5640_MIC1_OVTH_600UA);
	...
	if (pressed)
		snd_soc_update_bits(codec, RT5640_IRQ_CTRL2,
			RT5640_MB1_OC_P_MASK, RT5640_MB1_OC_P_INV);
	else
		snd_soc_update_bits(codec, RT5640_IRQ_CTRL2,
			RT5640_MB1_OC_P_MASK, RT5640_MB1_OC_P_NOR);
...
static int set_dmic1_clk(struct snd_soc_dapm_widget *w,
	struct snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_codec *codec = w->codec;
	...
	case SND_SOC_DAPM_POST_PMD:
		snd_soc_update_bits(codec, RT5640_DMIC,
			RT5640_DMIC_1_EN_MASK, RT5640_DMIC_1_DIS);
	default:
		return 0;
	}
...
static int set_dmic2_clk(struct snd_soc_dapm_widget *w,
	struct snd_kcontrol *kcontrol, int event)
{
	struct snd_soc_codec *codec = w->codec;
	...
	case SND_SOC_DAPM_POST_PMD:
		snd_soc_update_bits(codec, RT5640_DMIC,
			RT5640_DMIC_2_EN_MASK, RT5640_DMIC_2_DIS);
	default:
		return 0;
	}
		...
		struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
#ifdef USE_EQ
		rt5640_update_eqmode(codec, SPK, 0);
#endif
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
#ifdef USE_EQ
		rt5640_update_eqmode(codec, HP, 0);
#endif
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMD:
#ifdef USE_EQ
		rt5640_update_eqmode(codec, NORMAL, 0);
#endif
		break;
	default:
		return 0;
...
static const struct snd_soc_dapm_widget rt5640_dapm_widgets[] = {
	...
	SND_SOC_DAPM_SUPPLY("DMIC1 CLK", SND_SOC_NOPM, 0, 0,
		set_dmic1_clk, SND_SOC_DAPM_POST_PMD),
	SND_SOC_DAPM_SUPPLY("DMIC2 CLK", SND_SOC_NOPM, 0, 0,
		set_dmic2_clk, SND_SOC_DAPM_POST_PMD),
	/* Boost */
...
static const struct snd_soc_dapm_route rt5640_dapm_routes[] = {
	...
	{"DMIC L1", NULL, "DMIC1 CLK"},
	{"DMIC R1", NULL, "DMIC CLK"},
	{"DMIC R1", NULL, "DMIC1 CLK"},
	{"DMIC L2", NULL, "DMIC CLK"},
	{"DMIC L2", NULL, "DMIC2 CLK"},
	{"DMIC R2", NULL, "DMIC CLK"},
	{"DMIC R2", NULL, "DMIC2 CLK"},
