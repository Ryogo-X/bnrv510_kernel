...
#ifdef CONFIG_MACH_MX6SL_NTX //[
//#define MXCFB_WAIT_FOR_VSYNC	_IOR('F', 0x20, u_int32_t) // ICS version .
#define MXCFB_WAIT_FOR_VSYNC	_IOR('F', 0x20, unsigned long long)
#else//][!CONFIG_MACH_MX6SL_NTX
#define MXCFB_WAIT_FOR_VSYNC	_IOR('F', 0x20, unsigned long long)
#endif//]CONFIG_MACH_MX6SL_NTX
...
#define MXCFB_SEND_UPDATE_ORG		_IOW('F', 0x2E, struct mxcfb_update_data_org)
		...
		//#define MXCFB_WAIT_FOR_UPDATE_COMPLETE2 _IOWR('F', 0x2F, struct mxcfb_update_marker_data)
	#else //][!MX50_IOCTL_IF
		//#define MXCFB_WAIT_FOR_UPDATE_COMPLETE _IOWR('F', 0x35, struct mxcfb_update_marker_data) // ICS version 
		#define MXCFB_WAIT_FOR_UPDATE_COMPLETE _IOWR('F', 0x2F, struct mxcfb_update_marker_data) // ICS version 
	#endif//] MX50_IOCTL_IF
#else//][! CONFIG_MACH_MX6SL_NTX 
	#define MXCFB_WAIT_FOR_UPDATE_COMPLETE _IOWR('F', 0x2F, struct mxcfb_update_marker_data)
#endif//] CONFIG_MACH_MX6SL_NTX
